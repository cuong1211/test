                                                ...
                                                <div class="panel-heading" id="head_One">
                                                    <h4 class="panel-title">
                                                        <a class="collapsed" data-toggle="collapse"
                                                            data-parent="#accordion" href="#ques_one">
                                                            <iframe src="{{ $unit->slide->link }}" frameborder="0"
                                                                width="800" height="569" allowfullscreen="true"
                                                ...
                                                <div class="panel-heading" id="head_One1">
                                                    <h4 class="panel-title">
                                                        <a class="collapsed" data-toggle="collapse"
                                                            ...
                                                            <i class="fa fa-info"></i><span>/</span>Trắc nghiệm
                                                    ...
                                                    <div class="panel-body">
                                                        @foreach ($quizzes as $quiz)
                                                            <button type="button" class="btn btn-dark "><a
                                                                    href="{{ url('/quiz') . '/' . $quiz->id }}">{{ $quiz->quiz }}</a></button>
                                                ...
                                                <div class="panel-heading" id="head_two1">
                                                    <h4 class="panel-title">
                                                        <a class="collapsed" data-toggle="collapse"
                                                            ...
                                                            <i class="fa fa-hourglass-half"></i><span>/</span>Lập trình
                                                            <i class="fa fa-plus"></i>
                                                        </a>
                                                    </h4>
                                                </div>
