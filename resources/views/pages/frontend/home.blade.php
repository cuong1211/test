...
<div class="content_wrapper">
                    ...
                    <div id="rev_slider_104_1" class="rev_slider fullscreenbanner" style="display:none;"
                        ...
                        <ul>
                            ...
                            <li data-index="rs-309" data-transition="slideoverhorizontal" data-slotamount="default"
                                ...
                                data-thumb="images/slider_classroom.jpg" data-rotate="0" data-fstransition="fade"
                                data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"
                                data-title="Education" data-description="">

                                <img src="images/slider_classroom.jpg" alt="" data-bgposition="center center"
                                ...
                                <div class="tp-caption tp-shape tp-shapewrapper rs-parallaxlevel-0"
                                    ...
                                    data-width="full" data-height="['920','920','920','1070']" data-whitespace="nowrap"
                            ...
                            border-color: rgba(0, 0, 0, 0); background: rgba(0,0,0,0.45);">
                                ...
                                <div class="tp-caption BigBold-Title tp-resizeme rs-parallaxlevel-0"
                                    id="slide-309-layer-1" data-x="['left','left','left','left']"
                                    data-hoffset="['50','50','30','17']" data-height="none"
                                    data-y="['bottom','bottom','bottom','bottom']"
                                    data-voffset="['100','110','180','160']" data-fontsize="['70','70','49','42']"
                            ...
                            white-space: nowrap;">A Better Education
                                </div>
                            ...
                            white-space: normal;">A Better Education for a Better Word, Learn something new
                                    today.
                                </div>
                            ...
                            white-space: nowrap; border-color: rgba(255, 255, 255, 0.5); outline: none; box-shadow: none; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box;">
                                ...
                                <div class="tp-caption BigBold-Button rev-btn rs-parallaxlevel-0"
                                    id="slide-309-layer-12" data-x="['left','left','left','left']"
                            ...
                            <li data-index="rs-310" data-transition="slideoverhorizontal" data-slotamount="default"
                                ...
                                <img src="images/slider_with_instructor.jpg" alt="" data-bgposition="center center"
                                    data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10"
                                    class="rev-slidebg" data-no-retina>
                            ...
                            border-color: rgba(0, 0, 0, 0); background: rgba(0,0,0,0.45);">
                                ...
                                <div class="tp-caption BigBold-Title tp-resizeme rs-parallaxlevel-0"
                                    ...
                                    data-hoffset="['50','50','30','17']" data-height="none"
                                    data-y="['bottom','bottom','bottom','bottom']"
                                    data-voffset="['110','110','180','160']" data-fontsize="['70','70','49','42']"
                                    data-lineheight="['100','90','60','60']" data-width="['none','none','none','400']"
                                    data-whitespace="['nowrap','nowrap','nowrap','normal']" data-transform_idle="o:1;"
                                    data-mask_in="x:0px;y:[100%];" data-start="500"
                                    data-transform_in="y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;s:1500;e:Power3.easeInOut;"
                                    ...
                                    data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
                                    data-basealign="slide" data-responsive_offset="off" style="z-index: 6; 
                            white-space: nowrap;">Professional Instructor
                                </div>
                                ...
                                <div class="tp-caption BigBold-SubTitle rs-parallaxlevel-0" id="slide-310-layer-4"
                                    ...
                                    data-transform_out="y:50px;opacity:0;s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
                                    data-responsive="off" style="z-index: 7; min-width: 410px; max-width: 410px; max-width: 60px; 
                            white-space: normal;">A Highly Professional Instructors tested idea designed to
                            ...
                            <li data-index="rs-311" data-transition="slideoverhorizontal" data-slotamount="default"
                                ...
                                <img src="images/slider_inclass.jpg" alt="" data-bgposition="center center"
                                    data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10"
                                    class="rev-slidebg" data-no-retina>


                                <div class="tp-caption tp-shape tp-shapewrapper rs-parallaxlevel-0"
                                    id="slide-311-layer-11" data-x="['center','center','center','center']"
                                    data-hoffset="['0','0','0','0']" data-start="0"
                                    data-y="['bottom','bottom','bottom','bottom']" data-voffset="['0','0','0','0']"
                                    data-width="full" data-height="['920','920','920','1070']" data-whitespace="nowrap"
                                    data-responsive="off" data-transform_idle="o:1;" data-style_hover="cursor:default;"
                            ...
                            border-color: rgba(0, 0, 0, 0); background: rgba(0,0,0,0.45);">
                                ...
                                <div class="tp-caption BigBold-Title tp-resizeme rs-parallaxlevel-0"
                                    id="slide-311-layer-1" data-x="['left','left','left','left']"
                                    data-hoffset="['50','50','30','17']" data-height="none"
                                    data-y="['bottom','bottom','bottom','bottom']"
                                    data-voffset="['110','110','180','160']" data-fontsize="['70','70','49','42']"
                                    data-lineheight="['100','90','60','60']" data-width="['none','none','none','400']"
                                    ...
                                    data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
                                    data-basealign="slide" data-responsive_offset="off" style="z-index: 6; 
                            white-space: nowrap;">Learning Management System
                                </div>
                                ...
                                <div class="tp-caption BigBold-SubTitle rs-parallaxlevel-0" id="slide-311-layer-4"
                                    ...
                                    data-transform_out="y:50px;opacity:0;s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
                                    data-responsive="off" style="z-index: 7; min-width: 410px; max-width: 410px; max-width: 60px; 
                            white-space: normal;">Learning is not attained by chance, it must be sought for
                                    with ardor &amp; attended to with
                                    diligence.
                                </div>
                            ...
                            -webkit-box-sizing: border-box;">READ MORE
                                ...
                                <div class="tp-caption BigBold-Button rev-btn rs-parallaxlevel-0"
                                    id="slide-311-layer-12" data-x="['left','left','left','left']"
                                    data-hoffset="['676','676','226','216']"
                                    data-y="['bottom','bottom','bottom','bottom']" data-voffset="['50','50','30','20']"
                                    data-width="none" data-height="none" data-whitespace="nowrap"
                                    data-transform_idle="o:1;"
                ...
                <div class="find_course_txt_wrap col-md-8 col-xs-12">
                    <div class="find_course_txt">
                        <div class="head_part">
                            ...
                            <p>Sign-up today to join over 6 million learners already
                                on LearnMate Worldwide and more than 50,000
                                online courses available.</p>
                        </div>
                        <ul class="course_list">
                            <li class="fundamentals">
                                ...
                                <div class="course_info">
                                    ...
                                    <p>Lorem donec sapien phase dcua sed sa
                                        pellentesque lacus vamus lorem
                                        treb lum arcu semper duiac.</p>
                                </div>
                            </li>
                    ...
                    <div class="row find_course_form_inner">
                        ...
                        <form id="form_find_course" method="post" action="#">
                            ...
                            <div class="find_course_form_btn_wrap">
                                <button class="btn find_course_form_btn">Search
                                    Course</button>
                            </div>
                        </form>
                    </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 overview_m_padd">
                <div class="overview_info instructor col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="col-md-12 col-xs-12">
                        ...
                        <p>Highly qulified Instructors is here where you can study the
                            latest trends of the education.</p>
                        <a href="#">See More</a>
                    </div>
                    <figure><img alt="Professional Instructor" src="images/instructor.png">
                    </figure>
                </div>
                <div class="overview_info course col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="col-md-12 col-xs-12">
                        ...
                        <p>Online Courses &amp; Sessions is here where you can study the
                            latest trends of the education.</p>
                        <a href="#">See More</a>
                    </div>
                    <figure><img alt="Online Courses" src="images/online_courses.png">
                    </figure>
                </div>
                <div class="overview_info book col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="col-md-12 col-xs-12">
                        ...
                        <h5>Books &amp; Library</h5>
                        <p>Largest library center is here where you can study the latest
                            trends of the education.</p>
                        <a href="#">See More</a>
                    </div>
                    <figure><img alt="Books &amp; Library" src="images/library.png">
                    </figure>
                </div>
            </div>
        </div>
            ...
            <div class="course_wrapper">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="course_block">
                        <div class="img_wrap">
                            ...
                            <div class="course_img_hoverlay_btn"><a href="course_grid.html" title="View More"
                                    class="fa fa-eye"></a>
                            </div>
                        </div>
                        <div class="science">
                            ...
                            <div class="course_info">
                                <h4>Science</h4>
                                <p>Business Trends changing with latest courses
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="course_block">
                        ...
                        <div class="accounts">
                            <div class="icon"><i class="fa fa-sort-numeric-desc"></i>
                            </div>
                            <div class="course_info">
                                <h4>Accounting</h4>
                                <p>Business Trends changing with latest courses
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="course_block">
                        ...
                        <div class="psychology">
                            <div class="icon"><i class="fa fa-universal-access"></i>
                            </div>
                            <div class="course_info">
                                <h4>Psychology</h4>
                                <p>Business Trends changing with latest courses
    ...
    <div id="count" class="count" data-stellar-background-ratio="0.3"
        style="background: url(images/count_bg.jpg); background-attachment: fixed; background-position: 50% 50%;">
        <div class="container">
            <div class="head_part">
            ...
            <div class="row">
                <div class="col-sm-3 col-md-3 col-xs-6">
                    <div class="funfact expert text-center mb-sm-30">
                        ...
                        <div class="counts">
                            <h2 class="animate-number" data-animation-duration="2000" data-value="730">
                                0</h2>
        ...
        <div class="container">
            <div class="head_part">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                    tempor incididunt ut labore sit amet, consectetur adipisicing elit, sed
                    do eiusmod tempor incididunt ut labore. Lorem ipsum
            ...
            <div class="dtl_wrapper">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="dtl_block">
                        ...
                        <div class="blog_info">
                            <h3><a href="#">This Is Your Chance to Close the Reading
                                    Achievement Gap</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipicing
                                elit, sed do eiusmod tempor incididunt ut labore
                                sit amet, consectetur adipisicing elit, eiusmod
                                tempor incididunt ut sed se labore.
                                Lorem ipsum dolor sit amet, consectetur
                                adipisicing elit.</p>
                            <a href="blog_right_sidebar.html" class="btn_glob">Read
                                More</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="dtl_block">
                        ...
                        <div class="blog_info">
                            <h3><a href="#">Do Division I Athletes Get the Academics
                                    They Deserve?</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipicing
                                elit, sed do eiusmod tempor incididunt ut labore
                                sit amet, consectetur adipisicing elit, eiusmod
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="dtl_block">
                        ...
                        <div class="blog_info">
                            <h3><a href="#">Defining Learning Analytics and the
                                    Insights it Can Bring</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipicing
                                elit, sed do eiusmod tempor incididunt ut labore
                                sit amet, consectetur adipisicing elit, eiusmod
                                tempor incididunt ut sed se labore.
            ...
            <div class="slide">
                <div class="container">
                    <div class="testimonial_txt_wrap">
                        ...
                        <div class="client_role">Founder of Cenix Developers from 2014
                        </div>
                        <div class="client_message">
                            <p>
                                Lorem ipsum dolor sit amet, consectetur
                                adipisicing elit, sed do eiusmod tempor
                                incididunt ut labore sit amet, consectetur
                                adipisicing elit, sed do eiusmod tempor
                    ...
                    <div class="client_photo"><img src="images/leon_thompson.jpg" alt="Leon Thompson" /></div>
                </div>
            </div>
            <div class="slide">
                <div class="container">
                    <div class="testimonial_txt_wrap">
                        ...
                        <div class="client_role">Project Manager of Cenix Developers
                            from 2014</div>
                        <div class="client_message">
            ...
            <div class="slide">
                <div class="container">
                    <div class="testimonial_txt_wrap">
                        ...
                        <div class="client_role">Web Developer of Cenix Developers from
                            2014</div>
                        <div class="client_message">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing
                                elit, sed do eiusmod tempor incididunt ut labore
            ...
            <div class="slide">
                <div class="container">
                    <div class="testimonial_txt_wrap">
                        ...
                        <div class="client_role">Graphic Developer of Cenix Developers
                            from 2014</div>
                        <div class="client_message">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing
                                elit, sed do eiusmod tempor incididunt ut labore
        ...
        <div class="testimonials-nav__wrap">
            <div class="container">
                <div class="testimonials-nav">
                    <div class="slide_s"><img src="images/leon_thompson_s.jpg" alt="1" />
                    </div>
                    <div class="slide_s"><img src="images/ashley_moody_s.jpg" alt="2" />
                    </div>
    ...
    <div id="team" class="team">
        <div class="container">
            ...
            <div class="o-lecturers">
                <div class="o-lecturers-bg"
                    style="background: url(images/border_bg.png) no-repeat; background-size: 100% 100%;">

                    <div class="o-lecturers-teacher active style-1 position-center-x">
                        <a href="#itemslide0" class="o-teacher-img"><img src="images/fal_alaxander_louise_s.jpg"
                                alt="Alaxander Louise"></a>
                    </div>


                    <div class="o-lecturers-teacher style-2 position-center-x">
                        <a href="#itemslide1" class="o-teacher-img"><img src="images/fal_sarah_johnson_s.jpg"
                                alt="Sarah Johnson"></a>
                    </div>


                    <div class="o-lecturers-teacher  style-3 position-center-y">
                        <a href="#itemslide2" class="o-teacher-img"><img src="images/fal_leonardo_bonucci_s.jpg"
                                alt="Leonardo Bonucci"></a>
                    </div>


                    <div class="o-lecturers-teacher style-4 position-center-x">
                        <a href="#itemslide3" class="o-teacher-img"><img src="images/fal_rebeca_addam_s.jpg"
                                alt="Rebeca Addam"></a>
                    </div>


                    <div class="o-lecturers-teacher style-5 position-center-x">
                        <a href="#itemslide4" class="o-teacher-img"><img src="images/fal_barry_john_s.jpg"
                                alt="Barry John"></a>
                    </div>
                    ...
                    <div class="o-slider-detail o-teacher-detail position-center-y">
                        <div class="o-slide-item" data-hash="itemslide0">
                            <div class="detail-teacher-img"><img src="images/fal_alaxander_louise.jpg"
                                    alt="Alaxander Louise"></div>
                            <div class="teacher-detail">
                                <h3>Alaxander Louise<span>UI-UX Developer</span>
                                </h3>
                                <div class="social-icons">
                                    <ul>
                                        <li><a class="fa fa-facebook" href="#"></a>
                                        </li>
                                        <li><a class="fa fa-instagram" href="#"></a>
                                        </li>
                                        <li><a class="fa fa-google-plus" href="#"></a>
                                        </li>
                                        <li><a class="fa fa-twitter" href="#"></a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <a class="btn" href="teachers.html">View
                                    details</a>
                            </div>
                        </div>
                        <div class="o-slide-item" data-hash="itemslide1">
                            <div class="detail-teacher-img"><img src="images/fal_sarah_johnson.jpg" alt="Sarah Johnson">
                            </div>
                            <div class="teacher-detail">
                                <h3>Sarah Johnson<span>Graphic teacher</span>
                                </h3>
                                <div class="social-icons">
                                    <ul>
                                        <li><a class="fa fa-facebook" href="#"></a>
                        ...
                        <div class="o-slide-item" data-hash="itemslide2">
                            <div class="detail-teacher-img"><img src="images/fal_leonardo_bonucci.jpg"
                                    alt="Leonardo Bonucci"></div>
                            <div class="teacher-detail">
                                <h3>Leonardo Bonucci<span>Science teacher</span>
                                </h3>
                                <div class="social-icons">
                                    <ul>
                                        <li><a class="fa fa-facebook" href="#"></a>
                        ...
                        <div class="o-slide-item" data-hash="itemslide3">
                            <div class="detail-teacher-img"><img src="images/fal_rebeca_addam.jpg" alt="Rebeca Addam">
                            </div>
                            <div class="teacher-detail">
                        ...
                        <div class="o-slide-item" data-hash="itemslide4">
                            <div class="detail-teacher-img"><img src="images/fal_barry_john.jpg" alt="Barry John"></div>
                            <div class="teacher-detail">
    ...
    <div id="newsletter" class="newsletter" data-stellar-background-ratio="0.3"
        style="background: url(images/newsletter_bg.jpg); background-attachment: fixed; background-position: 50% 50%;">
        <div class="container">
